...
extern std::shared_ptr<const core::FrameBinary> parse(const ast::DistanceFrame& node, const dlplan::error_handler_type& error_handler, SyntacticElementFactory& context);
