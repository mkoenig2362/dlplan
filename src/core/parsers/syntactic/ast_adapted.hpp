...
BOOST_FUSION_ADAPT_STRUCT(dlplan::core::ast::MinimumNumerical, element)
BOOST_FUSION_ADAPT_STRUCT(dlplan::core::ast::MaximumNumerical, element)
BOOST_FUSION_ADAPT_STRUCT(dlplan::core::ast::SumFrameNumerical, element)
