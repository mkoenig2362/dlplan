...
bool IncrementNumericalEffect::evaluate(const core::State& source_state, const core::State& target_state) const {
    double source_eval = m_named_element->get_element()->evaluate(source_state);
    double target_eval = m_named_element->get_element()->evaluate(target_state);
...
bool IncrementNumericalEffect::evaluate(const core::State& source_state, const core::State& target_state, core::DenotationsCaches& caches) const {
    double source_eval = m_named_element->get_element()->evaluate(source_state, caches);
    double target_eval = m_named_element->get_element()->evaluate(target_state, caches);
    //if (source_eval == INF) return false;
    //if (target_eval == INF) return false;
    return source_eval < target_eval;
}
...
bool IncrementConceptEffect::evaluate(const core::State& source_state, const core::State& target_state) const {
    double source_eval = m_named_element->get_element()->evaluate(source_state).size();
    double target_eval = m_named_element->get_element()->evaluate(target_state).size();
    //if (source_eval == INF) return false;
    //if (target_eval == INF) return false;
    return source_eval < target_eval;
}
...
bool IncrementConceptEffect::evaluate(const core::State& source_state, const core::State& target_state, core::DenotationsCaches& caches) const {
    double source_eval = m_named_element->get_element()->evaluate(source_state, caches)->size();
    double target_eval = m_named_element->get_element()->evaluate(target_state, caches)->size();
    //if (source_eval == INF) return false;
    //if (target_eval == INF) return false;
    return source_eval < target_eval;
}
