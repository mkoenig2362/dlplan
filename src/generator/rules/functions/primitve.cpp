...
void PrimitiveFunction::generate_impl(const core::States& states, int target_complexity, GeneratorData& data, core::DenotationsCaches& caches) {
...
std::string PrimitiveFunction::get_name() const {
    return "f_primitive";
}
