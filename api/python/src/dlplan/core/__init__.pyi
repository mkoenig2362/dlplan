...
class FrameUnaryDenotation:
    ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def get_value(self, object_index: int) -> float: ...
    def set_value(self, object_index: int, value: float) -> None: ...
    def contains(self, object_index: int) -> bool: ...
    def insert(self, object_index: int, value: float) -> None: ...
    def erase(self, object_index: int) -> None: ...
    def empty(self) -> bool: ...
    def intersects(self, other: "FrameUnaryDenotation") -> bool: ...
    def is_subset_of(self, other: "FrameUnaryDenotation") -> bool: ...
    def to_vector(self) -> List[int]: ...
    def to_sorted_vector(self) -> List[int]: ...
    def get_num_objects(self) -> int: ...
...
class FrameBinaryDenotation:
    ...
    def __len__(self) -> int: ...
    def __hash__(self) -> int: ...
    def get_value(self, pair_of_object_indices: Tuple[int, int]) -> float: ...
    def set_value(self, pair_of_object_indices: Tuple[int, int], value: float) -> None: ...
    def contains(self, pair_of_object_indices: Tuple[int, int]) -> bool: ...
    def insert(self, pair_of_object_indices: Tuple[int, int], value: float) -> None: ...
    def erase(self, pair_of_object_indices: Tuple[int, int]) -> None: ...
    def empty(self) -> bool: ...
    def intersects(self, other: "FrameBinaryDenotation") -> bool: ...
    def is_subset_of(self, other: "FrameBinaryDenotation") -> bool: ...
    def to_vector(self) -> List[Tuple[int, int]]: ...
    def to_sorted_vector(self) -> List[Tuple[int, int]]: ...
    def get_num_objects(self) -> int: ...
...
class VocabularyInfo:
    ...
    def add_function(self, name: str, arity: int, is_static: bool) -> Function: ...
...
class InstanceInfo:
    ...
    @overload
    def add_function_atom(self, function: Function, objects: List[Object]) -> Atom: ...
    @overload
    def add_function_atom(self, function_name: str, object_names: List[str]) -> Atom: ...
    @overload
    def add_function_atom(self, function_index: int, object_indices: List[int]) -> Atom: ...
    @overload
    def add_function_static_atom(self, function: Function, objects: List[Object]) -> Atom: ...
    @overload
    def add_function_static_atom(self, function_name: str, object_names: List[str]) -> Atom: ...
    @overload
    def add_function_static_atom(self, function_index: int, object_indices: List[int]) -> Atom: ...
    def get_index(self) -> int: ...
...
class State:
    ...
    @overload
    def __init__(self, instance: InstanceInfo, atoms: List[Atom], atom_values: List[float]) -> None: ...
    @overload
    def __init__(self, instance: InstanceInfo, atom_indices: List[int], atom_values: List[float]) -> None: ...
    ...
    def get_atom_values(self) -> List[int]: ...
    def value_of(self, atom_id: int) -> float: ...
...
class FrameUnary():
    ...
    def get_vocabulary_info(self) -> VocabularyInfo: ...
    @overload
    def evaluate(self, state: State) -> FrameUnaryDenotation: ...
    @overload
    def evaluate(self, state: State, denotations_caches: DenotationsCaches) -> FrameUnaryDenotation: ...
    @overload
    def evaluate(self, states: List[State], denotations_caches: DenotationsCaches) -> List[FrameUnaryDenotation]: ...
...
class FrameBinary():
    ...
    def get_vocabulary_info(self) -> VocabularyInfo: ...
    @overload
    def evaluate(self, state: State) -> FrameBinaryDenotation: ...
    @overload
    def evaluate(self, state: State, denotations_caches: DenotationsCaches) -> FrameBinaryDenotation: ...
    @overload
    def evaluate(self, states: List[State], denotations_caches: DenotationsCaches) -> List[FrameBinaryDenotation]: ...
...
class SyntacticElementFactory:
    ...
    def parse_frame_unary(self, description: str, filename: str = "") -> FrameUnary: ...
    def parse_frame_binary(self, description: str, filename: str = "") -> FrameBinary: ...
    ...
    @overload
    def make_minimum_numerical(self, frame_unary: FrameUnary) -> Numerical: ...
    @overload
    def make_minimum_numerical(self, frame_binary: FrameBinary) -> Numerical: ...
    @overload
    def make_maximum_numerical(self, frame_unary: FrameUnary) -> Numerical: ...
    @overload
    def make_maximum_numerical(self, frame_binary: FrameBinary) -> Numerical: ...
    @overload
    def make_sum_frame_numerical(self, frame_unary: FrameUnary) -> Numerical: ...
    @overload
    def make_sum_frame_numerical(self, frame_binary: FrameBinary) -> Numerical: ...
    ...
    def make_primitive_frame_unary(self, function: Function, position: int) -> FrameUnary: ...
    def make_primitive_frame_binary(self, function: Function, position_first: int, position_second: int) -> FrameBinary: ...
    def make_restrict_frame_unary(self, frame_unary: FrameUnary, concept: Concept) -> FrameUnary: ...
    def make_restrict_frame_binary(self, frame_binary: FrameBinary, role: Role) -> FrameBinary: ...
    def make_distance_frame(self, frame_unary_1: FrameUnary, frame_unary_2: FrameUnary) -> FrameBinary: ...
