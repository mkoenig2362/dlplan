...
from ..core import State, DenotationsCaches, Boolean, Numerical, Concept, Role, FrameUnary, FrameBinary, SyntacticElementFactory
...
class NamedFrameUnary():
    def __str__(self) -> str: ...
    def get_key(self) -> str: ...
    def get_element(self) -> FrameUnary: ...


class NamedFrameBinary():
    def __str__(self) -> str: ...
    def get_key(self) -> str: ...
    def get_element(self) -> FrameBinary: ...
...
class PolicyFactory:
    ...
    def make_frame_unary(self, key: str, frame_unary: FrameUnary) -> NamedFrameUnary: ...
    def make_frame_binary(self, key: str, frame_binary: FrameBinary) -> NamedFrameBinary: ...
